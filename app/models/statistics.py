...
class BookStatistics(SQLModel, table=True):  # `table=False` to indicate this is a view
...
class UserStatistics(SQLModel, table=True):  # `table=False` to indicate this is a view
...
class UserReviewGenres(SQLModel, table=True):  # `table=False` to indicate this is a view
