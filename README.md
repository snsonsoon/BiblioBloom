...
이에 따라, Bibliobloom은 **"Reading, Reviewing, and Relating"** 이라는 캐치프레이즈를 중심으로 다음의 세 가지 핵심 목표를 지향합니다:

| **Reading (읽기): 독서의 습관화와 데이터화**                                            | **Reviewing (리뷰 작성): 지식과 감상의 기록**                                        | **Relating (소통과 연결): 독서 커뮤니티 활성화**                                      |
| ------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| - 사용자가 읽은 책을 기록하고, 개인의 독서 데이터를 시각적으로 확인할 수 있는 기능 제공 | - 사용자 리뷰 및 서평 작성을 통해 독서 경험을 정리하고 공유                         | - 사용자 간 서평 공감 및 순위 데이터를 통해 상호작용 유도                            |
| - 권장 도서 추천을 통해 독서 범위를 넓히고, 독서 습관 형성 지원                         | - 다른 독자들과의 소통을 통해 독서 문화를 더욱 풍요롭게 활성화                      | - 도서관 소장 정보 연계를 통해 도서 검색과 대여의 편의성 향상                        |
