...
최근 디지털 콘텐츠의 확산으로 독서량이 급격히 감소하고 있으며, 이는 개인의 문해력 저하와 독서 문화의 쇠퇴로 이어지고 있습니다.  
특히 체계적인 독서 기록과 피드백 부족으로 독서 습관을 유지하기 어려운 상황입니다.  

이에 따라, Bibliobloom은 독서를 기록하고, 리뷰를 작성하며, 사용자 간 소통을 통해 **독서의 습관화와 문해력 향상**을 돕기 위한 창의적이고 효과적인 접근을 제공합니다.

### 🌟 **캐치프레이즈**

Bibliobloom은 **"Reading, Reviewing, and Relating"** 이라는 캐치프레이즈를 중심으로 다음의 세 가지 핵심 목표를 지향합니다:

1. **Reading (읽기): 독서의 습관화와 데이터화**  
   - 사용자가 읽은 책을 기록하고, 개인의 독서 데이터를 시각적으로 확인할 수 있는 기능 제공  
   - 권장 도서 추천을 통해 독서 범위를 넓히고, 독서 습관 형성 지원  

2. **Reviewing (리뷰 작성): 지식과 감상의 기록**  
   - 사용자 리뷰 및 서평 작성을 통해 독서 경험을 정리하고 공유  
   - 다른 독자들과의 소통을 통해 독서 문화를 더욱 풍요롭게 활성화  

3. **Relating (소통과 연결): 독서 커뮤니티 활성화**  
   - 사용자 간 서평 공감 및 순위 데이터를 통해 상호작용 유도  
   - 도서관 소장 정보 연계를 통해 도서 검색과 대여의 편의성 향상  
  ...
  <tr>
    ...
    <td width="50%">
      ...
      <table>
        <tr>
          <td>🛠️ <b>정승원</b></td>
          <td>📋 프로젝트 기획 및 설계<br>🗄️ 데이터베이스 설계 및 구축<br>🔗 API 설계 및 연동<br>🖥️ 백엔드 개발<br>📢 발표 및 발표 자료 제작</td>
        </tr>
        <tr>
          <td>🎨 <b>정지우</b></td>
          <td>📋 프로젝트 기획 및 설계<br>🗄️ 데이터베이스 설계 전반<br>🔗 API 연동<br>🎨 UI/UX 디자인<br>💻 프론트엔드 개발<br>📝 프로젝트 문서화 및 보고서 작성</td>
        </tr>
      </table>
    </td>
  </tr>
